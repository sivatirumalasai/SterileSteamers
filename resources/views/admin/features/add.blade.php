          ...
          <div class="row">
            ...
            <div class="col-md-10">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="POST" enctype="multipart/form-data" action="{{ route("features.store") }}" >
                    @csrf
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label for="InputEmail1">Feature Name*</label>
                          <input type="text" value="{{ old('name') }}" name="name" class="form-control" id="InputEmail1" placeholder="Enter Name">
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="form-group">
                            <label for="InputPrice1">Code</label>
                            <input type="text" value="{{ old("code") }}" name="code" class="form-control" id="InputPrice1" placeholder="Enter code">
                        </div>
                      </div>
                    </div>
